create table tb_game (id  bigserial not null, platform int4, title varchar(255), genre_id int8, primary key (id));
create table tb_genre (id  bigserial not null, name varchar(255), primary key (id));
create table tb_record (id  bigserial not null, age int4, moment timestamp, name varchar(255), game_id int8, primary key (id));
